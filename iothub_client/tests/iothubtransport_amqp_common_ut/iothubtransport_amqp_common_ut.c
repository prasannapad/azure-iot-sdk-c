...
static void set_expected_calls_for_SendMessageDisposition(IOTHUBMESSAGE_DISPOSITION_RESULT iothc_disposition_result)
{
    ...
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_send_message_disposition(TEST_DEVICE_HANDLE, IGNORED_PTR_ARG, device_disposition_result))
        .IgnoreArgument(2);
...
static void set_expected_calls_for_Register(IOTHUB_DEVICE_CONFIG* device_config, bool is_using_cbs)
{
    ...
    EXPECTED_CALL(iothubtransport_amqp_device_create(IGNORED_PTR_ARG));
    ...
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_set_option(TEST_DEVICE_HANDLE, DEVICE_OPTION_EVENT_SEND_TIMEOUT_SECS, IGNORED_PTR_ARG))
        .IgnoreArgument(3);

    if (is_using_cbs)
    {
        STRICT_EXPECTED_CALL(iothubtransport_amqp_device_set_option(TEST_DEVICE_HANDLE, DEVICE_OPTION_CBS_REQUEST_TIMEOUT_SECS, IGNORED_PTR_ARG))
            .IgnoreArgument(3);
    }
...
static void set_expected_calls_for_Unregister(IOTHUB_DEVICE_HANDLE iothub_device_handle)
{
    ...
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_destroy(TEST_DEVICE_HANDLE));
...
static void set_expected_calls_for_send_pending_events(PDLIST_ENTRY wts, int expected_number_of_events)
{
    ...
    for (i = 0; i < expected_number_of_events; i++)
    {
        ...
        STRICT_EXPECTED_CALL(iothubtransport_amqp_device_send_event_async(TEST_DEVICE_HANDLE, TEST_IOTHUB_MESSAGE_LIST_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
            .IgnoreArgument(3)
            .IgnoreArgument(4);
    }
...
static void set_expected_calls_for_Device_DoWork(PDLIST_ENTRY wts, int wts_length, IOTHUBTRANSPORT_AMQP_DEVICE_STATE current_device_state, bool is_using_cbs, time_t current_time, bool subscribe_for_methods)
{
    if (current_device_state == DEVICE_STATE_STOPPED)
    {
        ...
        if (is_using_cbs)
        {
            ...
            STRICT_EXPECTED_CALL(iothubtransport_amqp_device_start_async(TEST_DEVICE_HANDLE, TEST_SESSION_HANDLE, TEST_CBS_HANDLE));
        }
        else
        {
            STRICT_EXPECTED_CALL(iothubtransport_amqp_device_start_async(TEST_DEVICE_HANDLE, TEST_SESSION_HANDLE, IGNORED_PTR_ARG));
        }
    }
    ...
    else if (current_device_state == DEVICE_STATE_ERROR_AUTH || current_device_state == DEVICE_STATE_ERROR_MSG)
    {
        ...
        STRICT_EXPECTED_CALL(iothubtransport_amqp_device_stop(TEST_DEVICE_HANDLE));
    }
    ...
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_do_work(TEST_DEVICE_HANDLE));
}
...
static void set_expected_calls_for_Subscribe(IOTHUB_DEVICE_CONFIG* device_config, IOTHUB_DEVICE_HANDLE registered_device)
{
    ...
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_subscribe_message(TEST_DEVICE_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument(2)
        .IgnoreArgument(3);
}
...
static void register_global_mock_hooks()
{
    ...
    REGISTER_GLOBAL_MOCK_HOOK(iothubtransport_amqp_device_create, TEST_device_create);
    REGISTER_GLOBAL_MOCK_HOOK(iothubtransport_amqp_device_subscribe_message, TEST_device_subscribe_message);
...
static void register_global_mock_returns()
{
    ...
    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_start_async, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_start_async, 1);

    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_stop, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_stop, 1);
    ...
    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_set_option, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_set_option, 1);

    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_subscribe_message, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_subscribe_message, 1);

    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_unsubscribe_message, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_unsubscribe_message, 1);

    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_get_send_status, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_get_send_status, 1);

    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_send_message_disposition, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_send_message_disposition, 1);

    REGISTER_GLOBAL_MOCK_RETURN(iothubtransport_amqp_device_get_twin_async, 0);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(iothubtransport_amqp_device_get_twin_async, 1);
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_073: [If iothubtransport_amqp_device_create() fails, IoTHubTransport_AMQP_Common_Register shall fail and return NULL]
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_01_011: [ If `iothubtransportamqp_methods_create` fails, `IoTHubTransport_AMQP_Common_Register` shall fail and return NULL]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_071: [`amqp_device_instance->device_handle` shall be set using iothubtransport_amqp_device_create()]
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_072: [The configuration for iothubtransport_amqp_device_create shall be set according to the authentication preferred by IOTHUB_DEVICE_CONFIG]
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_01_010: [ `IoTHubTransport_AMQP_Common_Register` shall create a new iothubtransportamqp_methods instance by calling `iothubtransportamqp_methods_create` while passing to it the the fully qualified domain name, the device Id, and optional module Id.]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_086: [iothubtransport_amqp_device_subscribe_message() shall be invoked passing `on_message_received_callback`]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_087: [If iothubtransport_amqp_device_subscribe_message() fails, IoTHubTransport_AMQP_Common_Subscribe shall return a non-zero result]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_095: [iothubtransport_amqp_device_unsubscribe_message() shall be invoked passing `amqp_device_instance->device_handle`]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_098: [If iothubtransport_amqp_device_get_send_status() fails, IoTHubTransport_AMQP_Common_GetSendStatus shall return IOTHUB_CLIENT_ERROR]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_097: [IoTHubTransport_AMQP_Common_GetSendStatus shall invoke iothubtransport_amqp_device_get_send_status()]
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_100: [If iothubtransport_amqp_device_get_send_status() returns DEVICE_SEND_STATUS_IDLE, IoTHubTransport_AMQP_Common_GetSendStatus shall return IOTHUB_CLIENT_OK and status IOTHUB_CLIENT_STATUS_IDLE]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_099: [If iothubtransport_amqp_device_get_send_status() returns DEVICE_SEND_STATUS_BUSY, IoTHubTransport_AMQP_Common_GetSendStatus shall return IOTHUB_CLIENT_OK and status IOTHUB_CLIENT_STATUS_BUSY]
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_102: [If `option` is a device-specific option, it shall be saved and applied to each registered device using iothubtransport_amqp_device_set_option()]
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_103: [If iothubtransport_amqp_device_set_option() fails, IoTHubTransport_AMQP_Common_SetOption shall return IOTHUB_CLIENT_ERROR]
TEST_FUNCTION(SetOption_device_specific_failure_check)
{
    ...
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_set_option(TEST_DEVICE_HANDLE, DEVICE_OPTION_EVENT_SEND_TIMEOUT_SECS, &value))
        .SetReturn(1);
    STRICT_EXPECTED_CALL(STRING_c_str(TEST_DEVICE_ID_STRING_HANDLE))
        .SetReturn(TEST_DEVICE_ID_CHAR_PTR);
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_041: [The device handle shall be started using iothubtransport_amqp_device_start_async()]
...
TEST_FUNCTION(IoTHubTransport_AMQP_Common_SendMessageDisposition_ACCEPTED_fails)
{
    ...
    umock_c_reset_all_calls();
    set_expected_calls_for_create_device_message_disposition_info();
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_send_message_disposition(TEST_DEVICE_HANDLE, IGNORED_PTR_ARG, DEVICE_MESSAGE_DISPOSITION_RESULT_ACCEPTED))
        .IgnoreArgument(2)
        .SetReturn(1);
...
TEST_FUNCTION(IoTHubTransport_AMQP_Common_SendMessageDisposition_ABANDONED_fails)
{
    ...
    umock_c_reset_all_calls();
    set_expected_calls_for_create_device_message_disposition_info();
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_send_message_disposition(TEST_DEVICE_HANDLE, IGNORED_PTR_ARG, DEVICE_MESSAGE_DISPOSITION_RESULT_RELEASED))
        .IgnoreArgument(2)
        .SetReturn(1);
    EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG))
        .SetReturn(TEST_DEVICE_ID_CHAR_PTR);
...
TEST_FUNCTION(IoTHubTransport_AMQP_Common_SendMessageDisposition_REJECTED_fails)
{
    ...
    umock_c_reset_all_calls();
    set_expected_calls_for_create_device_message_disposition_info();
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_send_message_disposition(TEST_DEVICE_HANDLE, IGNORED_PTR_ARG, DEVICE_MESSAGE_DISPOSITION_RESULT_REJECTED))
        .IgnoreArgument(2)
        .SetReturn(1);
    EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG))
        .SetReturn(TEST_DEVICE_ID_CHAR_PTR);
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_155: [ iothubtransport_amqp_device_get_twin_async() shall be invoked for the registered device, passing `on_device_get_twin_completed_callback`]
...
TEST_FUNCTION(IoTHubTransport_AMQP_Common_GetTwinAsync_success)
{
    ...
    STRICT_EXPECTED_CALL(iothubtransport_amqp_device_get_twin_async(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
...
// Tests_SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_156: [ If iothubtransport_amqp_device_get_twin_async() fails, `IoTHubTransport_AMQP_Common_GetTwinAsync` shall fail and return IOTHUB_CLIENT_ERROR ]
